...
int max_subsum(const int* nums, int left, int right) {
  ...
  int max_left_border_sum = INT_MIN, left_border_sum = 0;
  ...
  int max_right_border_sum = INT_MIN, right_border_sum = 0;
...
// Runtime: 8 ms, faster than 68.95% of C online submissions for Maximum
// Subarray. Memory Usage: 7.5 MB, less than 94.74% of C online submissions for
// Maximum Subarray.
